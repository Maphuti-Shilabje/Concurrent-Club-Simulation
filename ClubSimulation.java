	...
	public static void setupGUI(int frameX,int frameY,int [] exits) {
		...
		startB.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e)  {
				...
				/** this section of code sends the signal to notify the threads to start the game
				 * when the start buttorn is clicked
				 */
				synchronized(Clubgoer.isStart)
				{
					Clubgoer.isStart.set(true);
					Clubgoer.isStart.notifyAll();
				} 
		    }
		   });
